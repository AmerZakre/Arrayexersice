import java.util.Arrays;
  ...
  public class Namerepository { private static String [] names=new String[0];

      public static int getsize(){
          return names.length;

      }
      public static boolean setNames(String[] names) { // ["Jean " , "Jari "]

      Namerepository.setNames (new String[] ("Jean","Jari"));
